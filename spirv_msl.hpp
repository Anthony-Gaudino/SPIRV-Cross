...
public:
	...
	struct Options
	{
		...
		// Geometry/mesh pipeline support (branch addition): primitive topology of input vertices.
		// Needed by geometry shader lowering logic in spirv_msl.cpp (vertex_count_in_primitive, etc.).
		...
		PrimitiveTopology input_primitive_type = PrimitiveTopology::Triangles;
...
protected:
	...
	enum SPVFuncImpl : uint8_t
	{
		...
		// Geometry/Mesh pipeline helper retained from branch
		SPVFuncImplEmitVertex,
		// New upstream helper implementations
